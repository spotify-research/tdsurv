...
`spotify-research/tdsurv/main`
1.  Work with repo maintainers to get your change reviewed
1.  Wait for your change to be pulled into `spotify-research/tdsurv/main`
...
When creating an issue please try to adhere to the following format:
    ...
    tdsurv: One line summary of the issue (less than 72 characters)
...
columns (You can use `fmt -n -p -w 80` to accomplish this).
    ...
    tdsurv: One line description of your change (less than 72 characters)
...
docs. Please file an
[issue](https://github.com/spotify-research/tdsurv/issues).

# License

By contributing your code, you agree to license your contribution under the
terms of the APLv2:
https://github.com/spotify-research/tdsurv/blob/main/LICENSE
